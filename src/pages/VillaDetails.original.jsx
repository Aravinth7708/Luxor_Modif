...
export default function VillaDetails() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-white/10 transition-all duration-300 ${calendarOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <button
                onClick={() => navigate("/rooms")}
                className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 transition-all duration-200 group backdrop-blur-sm"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 transition-all duration-200 backdrop-blur-sm"
                onClick={async () => {
                  const shareData = {
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm">
              <div className="flex items-center gap-1 bg-white/10 rounded-lg px-2 py-1 backdrop-blur-sm">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`h-3 w-3 ${
              ...
              <div className="text-[#D4AF37]/90 bg-white/10 rounded-lg px-2 py-1 flex items-center gap-1 backdrop-blur-sm">
      ...
      <div className={`h-[180px] md:h-[165px] transition-all duration-300 ${calendarOpen ? 'h-0' : ''}`}></div>
