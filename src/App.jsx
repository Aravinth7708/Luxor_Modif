...
function App() {
  ...
  // Check if current path is in the admin section or villa details page
  const isOwnerPath = pathname.startsWith('/owner');
  const isVillaPage = pathname.startsWith('/villa') || pathname.startsWith('/villas');
  const hideNavbar = isOwnerPath || isVillaPage;
      ...
      <ToastProvider>
        <LanguageProvider>
          ...
          <div className="w-full max-w-[100vw] overflow-x-hidden">
            {!hideNavbar && <Navbar />}
            <div className={`min-h-[90vh] ${hideNavbar ? '' : 'pt-[3rem] md:pt-[4rem]'}`}>
