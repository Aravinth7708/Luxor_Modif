...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 w-full flex items-center justify-between px-4 md:px-6 lg:px-8 xl:px-10 transition-all duration-500 z-50 ${isScrolled
            ...
            <div className="hidden lg:flex flex-1 justify-center items-center gap-4 xl:gap-8 relative z-10">
                {navLinks.map((link, i) => (
                    <div
                        key={i}
