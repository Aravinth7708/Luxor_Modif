...
const BookingFormSection = ({
  ...
  return (
    ...
    >
      <div 
        className="backdrop-blur-[4px] p-6 sm:p-10 rounded-3xl border border-white/25 relative overflow-hidden text-white"
        style={{
          background: "rgba(0, 0, 0, 0.18)",
          boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.3), inset 0 1px 1px 0 rgba(255, 255, 255, 0.2)"
        }}
      >
        {/* Decorative elements for unique look */}
        <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-[#D4AF37]/15 to-transparent rounded-full blur-2xl pointer-events-none"></div>
        <div className="absolute -bottom-16 -left-16 w-32 h-32 bg-gradient-to-tr from-[#D4AF37]/10 to-transparent rounded-full blur-xl pointer-events-none"></div>
        {/* Booking Form Header */}
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="bg-[#D4AF37]/20 border border-[#D4AF37]/30 p-2.5 rounded-full">
        ...
        {/* Price Display */}
        <div 
          className="rounded-2xl p-4 mb-5 border border-white/15 backdrop-blur-[2px]"
        ...
        <form onSubmit={handleSearch} className="space-y-4 hero-form">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div style={datePickerWrapperStyles}>
                ...
                <DatePicker
                  ...
                  className="w-full p-2.5 text-[#D4AF37] border border-white/20 rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent hero-gold-focus"
            ...
            {searchParams.checkIn && searchParams.checkOut && (
              <div 
                className="rounded-xl p-3 border border-white/15 backdrop-blur-[2px]"
            ...
            <div>
              ...
              <Popover className="relative">
                {({ open }) => (
                  <>
                    <Popover.Button 
                      className="w-full flex justify-between items-center border border-white/20 text-white rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent hero-gold-focus"
                      style={{ background: "rgba(0, 0, 0, 0.22)" }}
                    >
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {amenities.map((amenity, index) => (
              <div 
                key={index} 
                className="flex items-center text-xs text-[#D4AF37] px-3 py-1.5 rounded-full border border-white/20 backdrop-blur-[2px]"
                style={{ background: "rgba(212, 175, 55, 0.12)" }}
              >
