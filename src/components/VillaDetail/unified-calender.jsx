...
export default function UnifiedCalendar({
                ...
                className={`
                  ...
                  ${isPast
                    ...
                    : isBlocked
                      ? getBlockedStyle()
                      : isCheckIn
                        ? "bg-gradient-to-r from-[#D4AF37] to-[#BFA181] text-white font-bold border-[#D4AF37] scale-105"
                        : isCheckOut
                          ? "bg-gradient-to-r from-[#BFA181] to-[#D4AF37] text-white font-bold border-[#BFA181] scale-105"
                          : isInRange
  ...
  useEffect(() => {
    if (isModal && isVisible && typeof document !== 'undefined') {
  ...
  // Early return if modal and not visible
  if (isModal && !isVisible) return null;

  const calendarContent = (
    <div className={`bg-white rounded-2xl ${isModal ? 'border border-gray-200 max-w-4xl w-[95%] sm:w-full max-h-[90vh] overflow-hidden relative z-[10000]' : 'w-full'}`}>
      {isModal && (
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100">
        <button
          ...
          className="w-8 h-8 rounded-full bg-gray-100 hover:bg-gradient-to-r hover:from-[#D4AF37] hover:to-[#BFA181] hover:text-white flex items-center justify-center transition-all hover:scale-110 cursor-pointer"
        >
      ...
      <div className={`px-2 py-3 overflow-y-auto ${isModal ? 'max-h-[45vh] sm:max-h-[50vh]' : ''}`}>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-3 w-full justify-center mt-2 sticky bottom-0 z-10 py-2 bg-gray-50">
            <button
              ...
              className="w-[30%] max-w-[120px] py-2 text-gray-700 hover:text-gray-900 font-medium text-base border border-gray-300 rounded-lg hover:border-[#D4AF37] bg-white hover:bg-gray-50 transition-all duration-200 cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={() => {
                if (tempCheckIn && tempCheckOut && onDateSelect) {
              ...
              className="w-[30%] max-w-[120px] py-2 bg-gradient-to-r from-[#D4AF37] to-[#BFA181] text-white rounded-lg hover:from-[#BFA181] hover:to-[#D4AF37] font-medium text-base transition-all duration-200 cursor-pointer"
            >
              <span className="flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
