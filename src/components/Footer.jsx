...
const Footer = () => {
  ...
  return (
    <footer className='bg-[#262626] text-gray-300 pt-12 px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 relative z-0' data-component="footer">
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6 relative'>
        ...
        <div>
          ...
          >
            <motion.p 
              className='font-playfair text-lg font-medium text-white border-b-2 border-[#D4AF37] pb-2 inline-block'
          ...
          <AnimatePresence>
            {(!isMobile || expandedSection.villas) && (
              <motion.ul 
                className='mt-5 flex flex-col gap-3 text-sm text-gray-400'
              ...
              >
                ...
                >
                  <Link to="/rooms" className="hover:text-[#D4AF37] transition-colors inline-block py-1 font-medium text-gray-300 hover:text-[#D4AF37]">View All Properties</Link>
                </motion.li>
              </motion.ul>
            )}
          </AnimatePresence>
        ...
        <div className='max-w-80'>
          ...
          >
            <div className="relative w-full">
              <input 
                type="email" 
                className='bg-white/10 text-white placeholder-gray-400 rounded-l-full sm:rounded-l-full rounded-full border border-white/20 h-11 px-4 outline-none focus:border-[#D4AF37] transition-colors w-full' 
              ...
              />
              {subscribeMessage && (
                <div className={`absolute -bottom-6 left-0 text-xs ${subscribeMessage.type === 'error' ? 'text-red-400' : 'text-green-400'}`}>
            ...
            <button 
              type="submit"
              className='flex items-center justify-center bg-[#D4AF37] h-11 px-5 sm:rounded-r-full rounded-full hover:bg-[#BFA181] transition-colors mt-3 sm:mt-0 sm:w-auto w-full cursor-pointer'
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col sm:flex-row items-center sm:items-start">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
              <a href="tel:+918015924647" className="text-gray-300 hover:text-[#D4AF37] transition-colors flex items-center">
              ...
              <a href="mailto:guna@luxorholidayhomestays.com" className="text-gray-300 hover:text-[#D4AF37] transition-colors flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-[#D4AF37]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <motion.div 
        className='flex flex-col md:flex-row gap-4 items-center justify-between py-6 text-gray-400'
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <ul className='flex flex-wrap items-center justify-center md:justify-end gap-4 md:gap-6'>
          <li>
            <Link 
              to="/privacy" 
              className="text-sm text-gray-400 hover:text-[#D4AF37] transition-colors relative group"
            >
              Privacy Policy
          ...
          <li className="relative group developers-link-container">
            <span 
              className="text-sm text-gray-400 hover:text-[#D4AF37] transition-colors relative group cursor-pointer"
              onClick={(e) => {
                e.preventDefault();
                if (isMobile) {
            ...
            >
              <div className="bg-[#242424] rounded-md shadow-xl p-3 border border-white/10 text-white">
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="relative group/dev">
                    <div 
                      className="text-xs text-gray-300 hover:text-[#D4AF37] transition-colors flex items-center cursor-pointer"
                    ...
                    <div 
                      className={`absolute ${isMobile ? 'top-full left-0 mt-1' : 'left-full top-0 ml-2'} w-52 
                        ...
                        transition-all duration-200 bg-[#242424] rounded-md shadow-xl p-2 border border-white/10 z-20`}
                    >
                      <div className="flex flex-col space-y-1.5">
                        ...
                        <a 
                          ...
                          className="text-xs text-gray-400 hover:text-[#D4AF37] flex items-center"
                          onClick={(e) => e.stopPropagation()}
                        >
                ...
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#242424] rotate-45 border-r border-b border-white/10"></div>
              </div>
            </div>
          </li>
          <li>
